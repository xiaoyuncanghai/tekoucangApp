...
import com.lion.classify.presenter.CommonPresenter;
import com.lion.classify.view.FlexibleLayout;
...
public abstract class CommonFragment<T extends CommonPresenter, V> extends Fragment implements View.OnClickListener, ViewCallBack<V> {
    public T presenter;
